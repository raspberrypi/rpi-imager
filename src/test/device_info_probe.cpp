 ...
 *
 * Prints KEY=value lines on stdout. Exits 0 whatever it finds: what is
 * interesting is what it says, and -- for a revision code it does not know
 * -- that it says anything at all rather than taking the process down.
 */
