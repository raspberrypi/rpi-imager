 ...
 *
 * The scroll is hover-only and stops for anyone who has asked their desktop
 * for reduced motion, so the static appearance is what most people see most
 * of the time. That is the part worth pinning.
 */
