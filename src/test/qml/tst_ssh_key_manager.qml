 ...
 * first boot.
 *
 * The parsing is more than splitting on newlines: PuTTY exports keys as a
 * multi-line block with a header, an optional comment and a body that has
 * to be joined back together. None of it had ever run in a test.
 */
