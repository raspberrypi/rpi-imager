 ...
 *
 * The comment above focusInitialItem() states the precondition the whole
 * thing rests on: "KeyNavigation.tab only works once something holds
 * focus". A dialog that opens with nothing focused is a dialog a keyboard
 * user cannot move around in at all.
 */
