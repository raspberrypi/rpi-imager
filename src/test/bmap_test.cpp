 ...
 *
 * The riskiest part is isMappedSequential(), which keeps a cursor so the
 * streaming encoder does not have to binary-search every block. It has to
 * agree with the plain isMapped() for every block, on any access pattern.
 */
