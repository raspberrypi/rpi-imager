...
//
// LinuxHelperFileOperations - routes privileged disk I/O through the PAL
// (LinuxPolkitBackend or LinuxEmbeddedBackend) instead of opening /dev/sdX
...
class LinuxWriteBufferProvider;

class LinuxHelperFileOperations : public FileOperations {
public:
    LinuxHelperFileOperations();
    ~LinuxHelperFileOperations() override;

    LinuxHelperFileOperations(const LinuxHelperFileOperations&) = delete;
    LinuxHelperFileOperations& operator=(const LinuxHelperFileOperations&) = delete;
...
private:
    friend class LinuxWriteBufferProvider;
