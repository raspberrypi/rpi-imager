...
Dialog {
    ...
    FocusScope {
        ...
        function rebuildFocusOrder() {
            ...
            //
            // An item a caller chose deliberately is kept as long as it is
            // still focusable, which is what PiConnectCustomizationStep
            // relies on when it lands on the description field.
